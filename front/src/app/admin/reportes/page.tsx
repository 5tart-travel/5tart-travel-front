...
const Reportes: React.FC = () => {
  ...
  const sendMessage = async (id: string) => {
    try {
      await axios.post(
        `${process.env.NEXT_PUBLIC_API_URL}/contact/sendEmail/${id}`,
      );
      Swal.fire({
        icon: 'success',
        ...
        {notifications.map((notification) => (
          ...
          >
            ...
            >
              <div className="w-1/3 bg-blue-950 flex flex-col justify-between p-4">
                <div className="text-center">
                  ...
                  <p className="text-indigo-500 text-sm text-shadow-white-semilight">
              ...
              <div className="w-2/3 p-4 relative">
                ...
                <div className="pl-6">
                  <div className="flex items-center mb-4 group">
                    ...
                    <Link
                      href={`mailto:${notification.mail}`}
                      className="text-gray-800 truncate w-[100px] relative"
                    >
                      {notification.mail}
                  ...
                  <div className="flex items-center space-x-4 mt-6 absolute bottom-6 gap-20">
                    ...
                    <button
                      className="cursor-pointer text-blue-950 hover:text-indigo-500"
                      onClick={(e) => {
                        e.stopPropagation();
            ...
            >
              <HiMailOpen
                size={30}
                className="absolute top-8 right-14 text-white z-10 "
              />
              <h3 className="text-xl font-semibold mb-2 bg-blue-950 px-4 py-2 rounded-br-full rounded-tl-full ">
                {notification.username}:
              </h3>

...
interface FormularioTravelProps {
  onClose: () => void;
  onAddTravel: (travel: ITravels) => void;
}

const FormularioTravel: React.FC<FormularioTravelProps> = ({ onClose, onAddTravel }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (nombre && sexo && raza && edad !== null && mes !== null && tamaño && selectedFile && especie) {
      try {
        ...
        console.log('Nueva Mascota:', nuevaTravel); 
        ...
        const mascotaResponse = await fetch('https://huellasdesperanza.onrender.com/pets', {
          ...
          body: JSON.stringify(nuevaTravel),
        });

...
const ViajesNacionales: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center mt-20 md:mt-40 bg-gray-100 h-auto  md:h-40 sm:h-40 xs:h-40 xxs:h-32  ">
      ...
      <div className="relative flex items-center w-full md:w-auto">
        ...
        <h2 className="relative z-10 px-4 text-2xl md:text-4xl font-bold text-blue-950 text-shadow-semidark text-center md:text-left sm:text-4xl xs:text-5xl xxs:text-5xl ">Viajes Nacionales</h2>
      </div>
      <div className="hidden md:block relative w-full md:w-auto  justify-center items-center">
        <Image 
          src="https://res.cloudinary.com/dia2gautk/image/upload/v1719878618/uqjfb5kuwhonq9a44kqr.webp" 

...
const Card4: React.FC<CardProps> = ({ data }) => {
  return (
    <div className="relative max-w-md w-full bg-neutral-800 box-shadow-white-semilight cursor-pointer hover:box-shadow-white-semidark rounded-2xl overflow-hidden flex">
      <div className="w-1/3 bg-neutral-900 flex flex-col justify-between p-4">
        ...
        <div className="text-center">
          ...
          <p className="text-indigo-500">{data.specialization}</p>
        </div>
      ...
      <div className="w-2/3 p-4 relative">
        ...
        <div className="pl-6">
          ...
          <IoMdStarHalf className="text-2xl text-indigo-400" />
            {data.especialidad2}
          </div>

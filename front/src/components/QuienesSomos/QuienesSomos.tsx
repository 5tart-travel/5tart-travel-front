   ...
   return (
     <div className={styles.container}>
         ...
         <section className="py-3">
            <h3 className="text-center mt-12 mb-4 italic text-2xl">Animate a explorar el mundo con nosotros</h3>
